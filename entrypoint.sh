...
watch_for_failure(){
        ...
        sudo -u splunk /opt/splunk/bin/splunk add monitor -source /gendata/*.log -sourcetype movie_snack_sales -index movie -auth admin:${SPLUNK_PASSWORD}
        sudo -u splunk /gendata/gentickets.sh /gendata /gendata/sales.log &
        wait
}
